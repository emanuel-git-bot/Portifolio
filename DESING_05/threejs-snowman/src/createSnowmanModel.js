...
function createStylizedSnowmanFigureModel(options = {}) {
  ...
  if (endpoint_root_0) {
    ...
    node_root_0.rotation.set(0, 0, -0.1222);
  } else {
    node_root_0.position.set(0, 0, 0);
    node_root_0.rotation.set(0, 0, -0.1222);
  }
  node_root_0.userData.sculptComponent = { "id": "root", "name": "Stylized Snowman Figure (root)", "level": "macro", "role": "body", "importance": 1, "confidence": 0.95, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "Rigid multi-primitive assembly; root is a pure transform group, not a mesh.", "geometryDescriptor": { "topologyIntent": "non-rendered bounding container / transform group only", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": null, "attachment": null, "dimensions": { "width": 1e-3, "height": 1e-3, "depth": 1e-3, "units": "world", "confidence": 0.95 }, "transform": { "position": [0, 0, 0], "rotation": [0, 0, -0.1222] }, "actionProfile": { "animationRole": "root", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "base" } }, "material": "bodySnow", "materialLayers": ["bodySnow"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Whole-figure -7deg screen-plane tilt is a confirmed CSS transform, mapped to root rotation.z." }, "evidenceRefs": ["full-object"], "details": [], "fidelityTier": "structure", "colorMaterialRecipe": { "materialClass": "unknown", "materialClassConfidence": 1, "dominantAlbedo": "rgba(128, 128, 128, 1.0)", "secondaryAlbedo": "rgba(128, 128, 128, 1.0)" } };
  ...
  if (!endpoint_root_0) {
    mesh_root_0Geometry.scale(1e-3, 1e-3, 1e-3);
  }
  const mesh_root_0 = new THREE.Mesh(
    mesh_root_0Geometry,
    materialMap["bodySnow"] ?? new THREE.MeshStandardMaterial({ color: 8947848 })
  );
  ...
  mesh_root_0.userData.sculptComponent = { "id": "root", "name": "Stylized Snowman Figure (root)", "level": "macro", "role": "body", "importance": 1, "confidence": 0.95, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "Rigid multi-primitive assembly; root is a pure transform group, not a mesh.", "geometryDescriptor": { "topologyIntent": "non-rendered bounding container / transform group only", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": null, "attachment": null, "dimensions": { "width": 1e-3, "height": 1e-3, "depth": 1e-3, "units": "world", "confidence": 0.95 }, "transform": { "position": [0, 0, 0], "rotation": [0, 0, -0.1222] }, "actionProfile": { "animationRole": "root", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "base" } }, "material": "bodySnow", "materialLayers": ["bodySnow"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Whole-figure -7deg screen-plane tilt is a confirmed CSS transform, mapped to root rotation.z." }, "evidenceRefs": ["full-object"], "details": [], "fidelityTier": "structure", "colorMaterialRecipe": { "materialClass": "unknown", "materialClassConfidence": 1, "dominantAlbedo": "rgba(128, 128, 128, 1.0)", "secondaryAlbedo": "rgba(128, 128, 128, 1.0)" } };
  ...
  mesh_bodyBottom_1.userData.sculptComponent = { "id": "bodyBottom", "name": "Body \u2014 bottom sphere", "level": "macro", "role": "body", "importance": 1, "confidence": 0.95, "primitive": "sphere", "topologyClass": "continuous-sculpt", "topologyRationale": "Largest of the three stacked spheres; continuous rounded volume, not a faceted primitive read.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "root", "attachment": null, "dimensions": { "radius": 0.5267, "units": "world", "confidence": 0.95, "height": 1.0534, "width": 1.0534, "depth": 1.0534 }, "transform": { "position": [0, 0.5267, 0], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "bodySnow" } }, "material": "bodySnow", "materialLayers": ["bodySnow"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Confirmed diameter ratio bottom:head = 1.95:1 (14.8rem:7.6rem)." }, "evidenceRefs": ["zone-r2c1"], "details": [], "fidelityTier": "form", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.95, "colorGradient": { "type": "radial", "stops": [{ "position": 0, "color": "rgba(255, 255, 255, 1.0)" }, { "position": 0.55, "color": "rgba(230, 235, 241, 1.0)" }, { "position": 1, "color": "rgba(195, 204, 214, 1.0)" }] }, "dominantAlbedo": "rgba(255, 255, 255, 1.0)", "secondaryAlbedo": "rgba(195, 204, 214, 1.0)" } };
  ...
  destructionGroups["melt-scatter"] ?? (destructionGroups["melt-scatter"] = []);
  ...
  if (endpoint_bodyMiddle_2) {
    ...
    node_bodyMiddle_2.rotation.set(0, 0, 0);
  } else {
    node_bodyMiddle_2.position.set(0, 1.2313, 0);
    node_bodyMiddle_2.rotation.set(0, 0, 0);
  }
  node_bodyMiddle_2.userData.sculptComponent = { "id": "bodyMiddle", "name": "Body \u2014 middle sphere", "level": "macro", "role": "body", "importance": 1, "confidence": 0.95, "primitive": "sphere", "topologyClass": "continuous-sculpt", "topologyRationale": "Mid-tier stacked sphere, overlaps bodyBottom at the seam.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "root", "attachment": { "parentSocket": "bodyBottom.top", "contactType": "overlap", "localStart": [0, 0.5267, 0], "localEnd": [0, 0.8541, 0], "embedDepth": 0.1495, "gapTolerance": 0 }, "dimensions": { "radius": 0.3772, "units": "world", "confidence": 0.95, "height": 0.7544, "width": 0.7544, "depth": 0.7544 }, "transform": { "position": [0, 1.2313, 0], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "bodySnow" } }, "material": "bodySnow", "materialLayers": ["bodySnow"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Confirmed diameter ratio middle:head = 1.4:1 (10.6rem:7.6rem); bottom-offset 12rem from ground." }, "evidenceRefs": ["zone-r2c1", "zone-r1c1"], "details": [], "fidelityTier": "form", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.95, "colorGradient": { "type": "radial", "stops": [{ "position": 0, "color": "rgba(255, 255, 255, 1.0)" }, { "position": 0.55, "color": "rgba(230, 235, 241, 1.0)" }, { "position": 1, "color": "rgba(195, 204, 214, 1.0)" }] }, "dominantAlbedo": "rgba(255, 255, 255, 1.0)", "secondaryAlbedo": "rgba(195, 204, 214, 1.0)" } };
  node_bodyMiddle_2.userData.actionProfile = { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "bodySnow" } };
  (nodes["root"] ?? root).add(node_bodyMiddle_2);
  nodes["bodyMiddle"] = node_bodyMiddle_2;
  const mesh_bodyMiddle_2Geometry = endpoint_bodyMiddle_2 ? new THREE.CylinderGeometry(endpoint_bodyMiddle_2.endRadius, endpoint_bodyMiddle_2.baseRadius, endpoint_bodyMiddle_2.length, 32, 12) : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_bodyMiddle_2) {
  ...
  mesh_bodyMiddle_2.userData.sculptComponent = { "id": "bodyMiddle", "name": "Body \u2014 middle sphere", "level": "macro", "role": "body", "importance": 1, "confidence": 0.95, "primitive": "sphere", "topologyClass": "continuous-sculpt", "topologyRationale": "Mid-tier stacked sphere, overlaps bodyBottom at the seam.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "root", "attachment": { "parentSocket": "bodyBottom.top", "contactType": "overlap", "localStart": [0, 0.5267, 0], "localEnd": [0, 0.8541, 0], "embedDepth": 0.1495, "gapTolerance": 0 }, "dimensions": { "radius": 0.3772, "units": "world", "confidence": 0.95, "height": 0.7544, "width": 0.7544, "depth": 0.7544 }, "transform": { "position": [0, 1.2313, 0], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "bodySnow" } }, "material": "bodySnow", "materialLayers": ["bodySnow"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Confirmed diameter ratio middle:head = 1.4:1 (10.6rem:7.6rem); bottom-offset 12rem from ground." }, "evidenceRefs": ["zone-r2c1", "zone-r1c1"], "details": [], "fidelityTier": "form", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.95, "colorGradient": { "type": "radial", "stops": [{ "position": 0, "color": "rgba(255, 255, 255, 1.0)" }, { "position": 0.55, "color": "rgba(230, 235, 241, 1.0)" }, { "position": 1, "color": "rgba(195, 204, 214, 1.0)" }] }, "dominantAlbedo": "rgba(255, 255, 255, 1.0)", "secondaryAlbedo": "rgba(195, 204, 214, 1.0)" } };
  ...
  if (endpoint_head_3) {
    ...
    node_head_3.position.set(0, 1.7295, 0);
    node_head_3.rotation.set(0, 0, 0);
  }
  node_head_3.userData.sculptComponent = { "id": "head", "name": "Head sphere", "level": "macro", "role": "body", "importance": 1, "confidence": 0.95, "primitive": "sphere", "topologyClass": "continuous-sculpt", "topologyRationale": "Smallest stacked sphere, carries hat/scarf/face sub-assemblies as children.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "root", "attachment": { "parentSocket": "bodyMiddle.top", "contactType": "overlap", "localStart": [0, 1.2313, 0], "localEnd": [0, 1.4591, 0], "embedDepth": 0.1068, "gapTolerance": 0 }, "dimensions": { "radius": 0.2705, "units": "world", "confidence": 0.95, "height": 0.541, "width": 0.541, "depth": 0.541 }, "transform": { "position": [0, 1.7295, 0], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "bodySnow" } }, "material": "bodySnow", "materialLayers": ["bodySnow"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Reference diameter 7.6rem, the unit against which all other proportions are ratioed." }, "evidenceRefs": ["zone-r1c1"], "details": [], "fidelityTier": "form", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.95, "colorGradient": { "type": "radial", "stops": [{ "position": 0, "color": "rgba(255, 255, 255, 1.0)" }, { "position": 0.55, "color": "rgba(230, 235, 241, 1.0)" }, { "position": 1, "color": "rgba(195, 204, 214, 1.0)" }] }, "dominantAlbedo": "rgba(255, 255, 255, 1.0)", "secondaryAlbedo": "rgba(195, 204, 214, 1.0)" } };
  node_head_3.userData.actionProfile = { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "bodySnow" } };
  (nodes["root"] ?? root).add(node_head_3);
  nodes["head"] = node_head_3;
  const mesh_head_3Geometry = endpoint_head_3 ? new THREE.CylinderGeometry(endpoint_head_3.endRadius, endpoint_head_3.baseRadius, endpoint_head_3.length, 32, 12) : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_head_3) {
  ...
  const attachment_hatBrim_4 = { "parentSocket": "head.top", "contactType": "flush-with", "localStart": [0, 0.2136, 0], "localEnd": [0, 0.2136, 0], "embedDepth": 0.0285, "gapTolerance": 0 };
  ...
  if (endpoint_hatBrim_4) {
    ...
    node_hatBrim_4.rotation.set(0, 0, -0.0698);
  } else {
    node_hatBrim_4.position.set(0, 0.242, 0);
    node_hatBrim_4.rotation.set(0, 0, -0.0698);
  }
  node_hatBrim_4.userData.sculptComponent = { "id": "hatBrim", "name": "Hat brim", "level": "meso", "role": "sub-assembly", "importance": 0.8, "confidence": 0.9, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Flat wide disc, overhangs the head silhouette on both sides -- a hard-surface flat primitive, not organic.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "head", "attachment": { "parentSocket": "head.top", "contactType": "flush-with", "localStart": [0, 0.2136, 0], "localEnd": [0, 0.2136, 0], "embedDepth": 0.0285, "gapTolerance": 0 }, "dimensions": { "radius": 0.2704, "height": 0.0641, "units": "world", "confidence": 0.9 }, "transform": { "position": [0, 0.242, 0], "rotation": [0, 0, -0.0698] }, "actionProfile": { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.9 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "hatDark" } }, "material": "hatDark", "materialLayers": ["hatDark"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Brim width 7.6rem = matches head diameter exactly (overhang reads at the very silhouette edge)." }, "evidenceRefs": ["zone-r0c1", "zone-r1c1"], "details": [], "fidelityTier": "form", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.9, "colorGradient": { "type": "linear", "stops": [{ "position": 0, "color": "rgba(42, 45, 51, 1.0)" }, { "position": 1, "color": "rgba(23, 25, 28, 1.0)" }] }, "dominantAlbedo": "rgba(42, 45, 51, 1.0)", "secondaryAlbedo": "rgba(23, 25, 28, 1.0)" } };
  node_hatBrim_4.userData.actionProfile = { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.9 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "hatDark" } };
  (nodes["head"] ?? root).add(node_hatBrim_4);
  nodes["hatBrim"] = node_hatBrim_4;
  const mesh_hatBrim_4Geometry = endpoint_hatBrim_4 ? new THREE.CylinderGeometry(endpoint_hatBrim_4.endRadius, endpoint_hatBrim_4.baseRadius, endpoint_hatBrim_4.length, 32, 12) : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  if (!endpoint_hatBrim_4) {
    mesh_hatBrim_4Geometry.scale(0.5408, 0.0641, 0.5408);
  }
  const mesh_hatBrim_4 = new THREE.Mesh(
    mesh_hatBrim_4Geometry,
    materialMap["hatDark"] ?? new THREE.MeshStandardMaterial({ color: 8947848 })
  );
  ...
  const attachment_hatTop_5 = { "parentSocket": "hatBrim.top", "contactType": "flush-with", "localStart": [0, 0.242, 0], "localEnd": [0, 0.242, 0], "embedDepth": 0.0214, "gapTolerance": 0 };
  ...
  if (endpoint_hatTop_5) {
    ...
    node_hatTop_5.rotation.set(0, 0, -0.0698);
  } else {
    node_hatTop_5.position.set(0, 0.3986, 0);
    node_hatTop_5.rotation.set(0, 0, -0.0698);
  }
  node_hatTop_5.userData.sculptComponent = { "id": "hatTop", "name": "Hat crown (top cylinder)", "level": "meso", "role": "sub-assembly", "importance": 0.7, "confidence": 0.9, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Tall narrow cylinder sitting on the brim.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "head", "attachment": { "parentSocket": "hatBrim.top", "contactType": "flush-with", "localStart": [0, 0.242, 0], "localEnd": [0, 0.242, 0], "embedDepth": 0.0214, "gapTolerance": 0 }, "dimensions": { "radius": 0.1744, "height": 0.2277, "units": "world", "confidence": 0.9 }, "transform": { "position": [0, 0.3986, 0], "rotation": [0, 0, -0.0698] }, "actionProfile": { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.9 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "hatCrown" } }, "material": "hatCrown", "materialLayers": ["hatCrown"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Crown reads marginally lighter/bluer than brim per confirmed CSS gradient stops." }, "evidenceRefs": ["zone-r0c1"], "details": [], "fidelityTier": "form", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.9, "colorGradient": { "type": "linear", "stops": [{ "position": 0, "color": "rgba(51, 54, 61, 1.0)" }, { "position": 1, "color": "rgba(27, 29, 33, 1.0)" }] }, "dominantAlbedo": "rgba(51, 54, 61, 1.0)", "secondaryAlbedo": "rgba(27, 29, 33, 1.0)" } };
  node_hatTop_5.userData.actionProfile = { "animationRole": "detachable", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.9 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": true, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": true, "fractureGroup": "melt-scatter", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "hatCrown" } };
  (nodes["head"] ?? root).add(node_hatTop_5);
  nodes["hatTop"] = node_hatTop_5;
  const mesh_hatTop_5Geometry = endpoint_hatTop_5 ? new THREE.CylinderGeometry(endpoint_hatTop_5.endRadius, endpoint_hatTop_5.baseRadius, endpoint_hatTop_5.length, 32, 12) : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  if (!endpoint_hatTop_5) {
    mesh_hatTop_5Geometry.scale(0.3488, 0.2277, 0.3488);
  }
  const mesh_hatTop_5 = new THREE.Mesh(
    mesh_hatTop_5Geometry,
    materialMap["hatCrown"] ?? new THREE.MeshStandardMaterial({ color: 8947848 })
  );
  ...
  const attachment_scarfBand_6 = { "parentSocket": "head-bodyMiddle.seam", "contactType": "embed", "localStart": [0, -0.064, 0], "localEnd": [0, -0.064, 0], "embedDepth": 0.0641, "gapTolerance": 0 };
  ...
  if (endpoint_scarfBand_6) {
    ...
    node_scarfBand_6.rotation.set(0, 0, 0);
  } else {
    node_scarfBand_6.position.set(0, -0.064, 0.1779);
    node_scarfBand_6.rotation.set(0, 0, 0);
  }
  node_scarfBand_6.userData.sculptComponent = { "id": "scarfBand", "name": "Scarf band", "level": "meso", "role": "sub-assembly", "importance": 0.85, "confidence": 0.85, "primitive": "capsule", "topologyClass": "conforming-shell", "topologyRationale": "Curved band wrapping the head/bodyMiddle seam; domed top edge, near-flat hem -- a capsule/rounded-box hybrid, not a torus (it does not fully encircle at uniform radius).", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "head", "attachment": { "parentSocket": "head-bodyMiddle.seam", "contactType": "embed", "localStart": [0, -0.064, 0], "localEnd": [0, -0.064, 0], "embedDepth": 0.0641, "gapTolerance": 0 }, "dimensions": { "width": 0.6121, "height": 0.121, "depth": 0.2491, "units": "world", "confidence": 0.85 }, "transform": { "position": [0, -0.064, 0.1779], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "scarfAccent" } }, "material": "scarfAccent", "materialLayers": ["scarfAccent"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["domed-top-edge (border-radius 2.3rem confirmed)", "near-flat hem (border-radius 4px confirmed)"], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Vertical gradient lighter-top-to-darker-hem confirmed from CSS linear-gradient(180deg,...)." }, "evidenceRefs": ["zone-r1c1"], "details": [], "fidelityTier": "form", "colorMaterialRecipe": { "materialClass": "fabric", "materialClassConfidence": 0.9, "colorGradient": { "type": "linear", "stops": [{ "position": 0, "color": "rgba(194, 164, 255, 1.0)" }, { "position": 1, "color": "rgba(127, 64, 255, 1.0)" }] }, "dominantAlbedo": "rgba(194, 164, 255, 1.0)", "secondaryAlbedo": "rgba(127, 64, 255, 1.0)" } };
  node_scarfBand_6.userData.actionProfile = { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "scarfAccent" } };
  (nodes["head"] ?? root).add(node_scarfBand_6);
  nodes["scarfBand"] = node_scarfBand_6;
  const mesh_scarfBand_6Geometry = endpoint_scarfBand_6 ? new THREE.CylinderGeometry(endpoint_scarfBand_6.endRadius, endpoint_scarfBand_6.baseRadius, endpoint_scarfBand_6.length, 32, 12) : buildWatertightCapsule(0.35, 0.7, 16, 32, 1);
  if (!endpoint_scarfBand_6) {
    mesh_scarfBand_6Geometry.scale(0.6121, 0.121, 0.2491);
  }
  const mesh_scarfBand_6 = new THREE.Mesh(
    mesh_scarfBand_6Geometry,
    materialMap["scarfAccent"] ?? new THREE.MeshStandardMaterial({ color: 8947848 })
  );
  ...
  const mesh_eyeLeft_8Geometry = endpoint_eyeLeft_8 ? new THREE.CylinderGeometry(endpoint_eyeLeft_8.endRadius, endpoint_eyeLeft_8.baseRadius, endpoint_eyeLeft_8.length, 32, 12) : new THREE.PlaneGeometry(1, 1, 24, 24);
  if (!endpoint_eyeLeft_8) {
    mesh_eyeLeft_8Geometry.scale(0.0996, 0.0996, 0.02);
  }
  const mesh_eyeLeft_8 = new THREE.Mesh(
    mesh_eyeLeft_8Geometry,
    materialMap["darkAccent"] ?? new THREE.MeshStandardMaterial({ color: 8947848 })
  );
  ...
  if (endpoint_eyeRight_9) {
    ...
    node_eyeRight_9.rotation.set(0, 0, 0);
  } else {
    node_eyeRight_9.position.set(0.0783, 0.0427, 0.2278);
    node_eyeRight_9.rotation.set(0, 0, 0);
  }
  node_eyeRight_9.userData.sculptComponent = { "id": "eyeRight", "name": "Eye mark (distal, further from center)", "level": "micro", "role": "detail", "importance": 0.9, "confidence": 0.9, "primitive": "plane-card", "topologyClass": "conforming-shell", "topologyRationale": "Flat applied circular mark conforming to the head's surface -- confirmed from the CSS source as a 2D border-radius circle with an inset box-shadow highlight, not a carved depth cavity. A plane-card decal is the faithful representation; a real SDF-subtract socket would add a physical dent the reference does not show.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "head", "attachment": { "parentSocket": "head.front", "contactType": "flush-with", "localStart": [0, -1.7295, 0], "localEnd": [0, -1.7295, 0], "embedDepth": 0.0214, "gapTolerance": 0 }, "dimensions": { "width": 0.0996, "height": 0.0996, "depth": 0.02, "units": "world", "confidence": 0.9 }, "transform": { "position": [0.0783, 0.0427, 0.2278], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.9 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "darkAccent" } }, "material": "darkAccent", "materialLayers": ["darkAccent"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "" }, "evidenceRefs": ["zone-r1c1"], "details": [], "fidelityTier": "micro", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.85, "colorGradient": { "type": "linear", "stops": [{ "position": 0, "color": "rgba(26, 26, 26, 1.0)" }, { "position": 1, "color": "rgba(26, 26, 26, 1.0)" }] }, "dominantAlbedo": "rgba(26, 26, 26, 1.0)", "secondaryAlbedo": "rgba(26, 26, 26, 1.0)" } };
  node_eyeRight_9.userData.actionProfile = { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.9 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "darkAccent" } };
  (nodes["head"] ?? root).add(node_eyeRight_9);
  nodes["eyeRight"] = node_eyeRight_9;
  const mesh_eyeRight_9Geometry = endpoint_eyeRight_9 ? new THREE.CylinderGeometry(endpoint_eyeRight_9.endRadius, endpoint_eyeRight_9.baseRadius, endpoint_eyeRight_9.length, 32, 12) : new THREE.PlaneGeometry(1, 1, 24, 24);
  if (!endpoint_eyeRight_9) {
  ...
  if (endpoint_pupilLeft_10) {
    ...
    node_pupilLeft_10.rotation.set(0, 0, 0);
  } else {
    node_pupilLeft_10.position.set(71e-4, 72e-4, 0.0284);
    node_pupilLeft_10.rotation.set(0, 0, 0);
  }
  node_pupilLeft_10.userData.sculptComponent = { "id": "pupilLeft", "name": "Pupil highlight (left eye)", "level": "micro", "role": "detail", "importance": 0.3, "confidence": 0.8, "primitive": "plane-card", "topologyClass": "conforming-shell", "topologyRationale": "Small flat gloss-highlight decal on top of the eye mark, conforming to the same surface.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "eyeLeft", "attachment": null, "dimensions": { "width": 0.027, "height": 0.027, "depth": 0.01, "units": "world", "confidence": 0.8 }, "transform": { "position": [71e-4, 72e-4, 0.0284], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.8 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "pupilLight" } }, "material": "pupilLight", "materialLayers": ["pupilLight"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "" }, "evidenceRefs": ["zone-r1c1"], "details": [], "fidelityTier": "micro", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.8, "colorGradient": { "type": "linear", "stops": [{ "position": 0, "color": "rgba(234, 229, 236, 1.0)" }, { "position": 1, "color": "rgba(234, 229, 236, 1.0)" }] }, "dominantAlbedo": "rgba(234, 229, 236, 1.0)", "secondaryAlbedo": "rgba(234, 229, 236, 1.0)" } };
  node_pupilLeft_10.userData.actionProfile = { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.8 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "pupilLight" } };
  (nodes["eyeLeft"] ?? root).add(node_pupilLeft_10);
  nodes["pupilLeft"] = node_pupilLeft_10;
  const mesh_pupilLeft_10Geometry = endpoint_pupilLeft_10 ? new THREE.CylinderGeometry(endpoint_pupilLeft_10.endRadius, endpoint_pupilLeft_10.baseRadius, endpoint_pupilLeft_10.length, 32, 12) : new THREE.PlaneGeometry(1, 1, 24, 24);
  if (!endpoint_pupilLeft_10) {
    mesh_pupilLeft_10Geometry.scale(0.027, 0.027, 0.01);
  }
  const mesh_pupilLeft_10 = new THREE.Mesh(
    mesh_pupilLeft_10Geometry,
    materialMap["pupilLight"] ?? new THREE.MeshStandardMaterial({ color: 8947848 })
  );
  ...
  if (endpoint_pupilRight_11) {
    ...
    node_pupilRight_11.rotation.set(0, 0, 0);
  } else {
    node_pupilRight_11.position.set(71e-4, 72e-4, 0.0284);
    node_pupilRight_11.rotation.set(0, 0, 0);
  }
  ...
  const mesh_pupilRight_11Geometry = endpoint_pupilRight_11 ? new THREE.CylinderGeometry(endpoint_pupilRight_11.endRadius, endpoint_pupilRight_11.baseRadius, endpoint_pupilRight_11.length, 32, 12) : new THREE.PlaneGeometry(1, 1, 24, 24);
  if (!endpoint_pupilRight_11) {
  ...
  const attachment_nose_12 = { "parentSocket": "head.front", "contactType": "embedded-in", "localStart": [0, -1.7295, 0], "localEnd": [0, -1.7295, 0], "embedDepth": 71e-4, "gapTolerance": 0 };
  ...
  if (endpoint_button1_13) {
    ...
    node_button1_13.rotation.set(0, 0, 0);
  } else {
    node_button1_13.position.set(0.0854, 0.1566, 0.3345);
    node_button1_13.rotation.set(0, 0, 0);
  }
  node_button1_13.userData.sculptComponent = { "id": "button1", "name": "Coal button (top)", "level": "micro", "role": "detail", "importance": 0.4, "confidence": 0.85, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "First of 3 small dark spheres in a vertical row on the middle sphere's front.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "bodyMiddle", "attachment": { "parentSocket": "bodyMiddle.front", "contactType": "embedded-in", "localStart": [0, -1.2313, 0], "localEnd": [0, -1.2313, 0], "embedDepth": 0.0107, "gapTolerance": 0 }, "dimensions": { "radius": 0.0302, "units": "world", "confidence": 0.85, "height": 0.0604, "width": 0.0604, "depth": 0.0604 }, "transform": { "position": [0.0854, 0.1566, 0.3345], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "darkAccent" } }, "material": "darkAccent", "materialLayers": ["darkAccent"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "" }, "evidenceRefs": ["zone-r2c1"], "details": [], "fidelityTier": "micro", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.8, "colorGradient": { "type": "linear", "stops": [{ "position": 0, "color": "rgba(26, 26, 26, 1.0)" }, { "position": 1, "color": "rgba(26, 26, 26, 1.0)" }] }, "dominantAlbedo": "rgba(26, 26, 26, 1.0)", "secondaryAlbedo": "rgba(26, 26, 26, 1.0)" } };
  node_button1_13.userData.actionProfile = { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "darkAccent" } };
  (nodes["bodyMiddle"] ?? root).add(node_button1_13);
  nodes["button1"] = node_button1_13;
  const mesh_button1_13Geometry = endpoint_button1_13 ? new THREE.CylinderGeometry(endpoint_button1_13.endRadius, endpoint_button1_13.baseRadius, endpoint_button1_13.length, 32, 12) : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_button1_13) {
  ...
  const attachment_armLeft_14 = { "parentSocket": "bodyMiddle.upperLateral", "contactType": "socket", "localStart": [-0.4199, 0.3132, 0], "localEnd": [-0.4911, -0.1139, 0], "embedDepth": 0.0214, "gapTolerance": 0, "baseRadius": 0.032, "endRadius": 0.02 };
  ...
  socket_armLeft_shoulderSocket_0.position.set(-0.4199, 1.5445, 0);
  ...
  const attachment_armRight_15 = { "parentSocket": "bodyMiddle.upperLateral", "contactType": "socket", "localStart": [0.4199, 0.3132, 0], "localEnd": [0.4911, -0.1139, 0], "embedDepth": 0.0214, "gapTolerance": 0, "baseRadius": 0.032, "endRadius": 0.02 };
  ...
  if (endpoint_armRight_15) {
    ...
    node_armRight_15.rotation.set(0, 0, 0.4189);
  } else {
    node_armRight_15.position.set(0.4911, 0.1993, 0);
    node_armRight_15.rotation.set(0, 0, 0.4189);
  }
  ...
  const mesh_armRight_15Geometry = endpoint_armRight_15 ? new THREE.CylinderGeometry(endpoint_armRight_15.endRadius, endpoint_armRight_15.baseRadius, endpoint_armRight_15.length, 32, 12) : buildWatertightCapsule(0.35, 0.7, 16, 32, 1);
  if (!endpoint_armRight_15) {
  ...
  socket_armRight_shoulderSocket_0.position.set(0.4199, 1.5445, 0);
  ...
  const attachment_groundShadow_16 = { "parentSocket": "bodyBottom.groundContact", "contactType": "below", "localStart": [0, 0, 0], "localEnd": [0, 0.05, 0], "embedDepth": 0.01, "gapTolerance": 0 };
  ...
  if (endpoint_groundShadow_16) {
    ...
    node_groundShadow_16.rotation.set(0, 0, 0);
  } else {
    node_groundShadow_16.position.set(0, 36e-4, 0);
    node_groundShadow_16.rotation.set(0, 0, 0);
  }
  node_groundShadow_16.userData.sculptComponent = { "id": "groundShadow", "name": "Ground contact shadow", "level": "macro", "role": "body", "importance": 0.3, "confidence": 0.7, "primitive": "cylinder", "topologyClass": "material-only", "topologyRationale": "Flat, blurred, near-transparent dark ellipse on the ground plane beneath bodyBottom -- not a raised part.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "root", "attachment": { "parentSocket": "bodyBottom.groundContact", "contactType": "below", "localStart": [0, 0, 0], "localEnd": [0, 0.05, 0], "embedDepth": 0.01, "gapTolerance": 0 }, "dimensions": { "radiusTop": 0.516, "radiusBottom": 0.516, "height": 36e-4, "units": "world", "confidence": 0.7 }, "transform": { "position": [0, 36e-4, 0], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "darkAccent" } }, "material": "darkAccent", "materialLayers": ["darkAccent"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "Rendered as a flat radial-gradient-alpha disc (or a soft shadow-catcher plane), not solid geometry with the darkAccent material's normal roughness/gloss -- opacity fades to 0 at the rim." }, "evidenceRefs": ["zone-r2c1"], "details": [], "fidelityTier": "form", "colorMaterialRecipe": { "materialClass": "unknown", "materialClassConfidence": 0.7, "colorGradient": { "type": "radial", "stops": [{ "position": 0, "color": "rgba(0, 0, 0, 1.0)" }, { "position": 1, "color": "rgba(0, 0, 0, 1.0)" }] }, "dominantAlbedo": "rgba(0, 0, 0, 1.0)", "secondaryAlbedo": "rgba(0, 0, 0, 1.0)" } };
  ...
  const mesh_groundShadow_16Geometry = endpoint_groundShadow_16 ? new THREE.CylinderGeometry(endpoint_groundShadow_16.endRadius, endpoint_groundShadow_16.baseRadius, endpoint_groundShadow_16.length, 32, 12) : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  if (!endpoint_groundShadow_16) {
    mesh_groundShadow_16Geometry.scale(1, 36e-4, 1);
  }
  ...
  if (endpoint_button2_17) {
    ...
    node_button2_17.rotation.set(0, 0, 0);
  } else {
    node_button2_17.position.set(0.0854, -0.0308, 0.3345);
    node_button2_17.rotation.set(0, 0, 0);
  }
  node_button2_17.userData.sculptComponent = { "id": "button2", "name": "Coal button (middle)", "level": "micro", "role": "detail", "importance": 0.4, "confidence": 0.85, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "First of 3 small dark spheres in a vertical row on the middle sphere's front.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "bodyMiddle", "attachment": { "parentSocket": "bodyMiddle.front", "contactType": "embedded-in", "localStart": [0, -1.2313, 0], "localEnd": [0, -1.2313, 0], "embedDepth": 0.0107, "gapTolerance": 0 }, "dimensions": { "radius": 0.0302, "units": "world", "confidence": 0.85, "height": 0.0604, "width": 0.0604, "depth": 0.0604 }, "transform": { "position": [0.0854, -0.0308, 0.3345], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "darkAccent" } }, "material": "darkAccent", "materialLayers": ["darkAccent"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "" }, "evidenceRefs": ["zone-r2c1"], "details": [], "fidelityTier": "micro", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.8, "colorGradient": { "type": "linear", "stops": [{ "position": 0, "color": "rgba(26, 26, 26, 1.0)" }, { "position": 1, "color": "rgba(26, 26, 26, 1.0)" }] }, "dominantAlbedo": "rgba(26, 26, 26, 1.0)", "secondaryAlbedo": "rgba(26, 26, 26, 1.0)" } };
  node_button2_17.userData.actionProfile = { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "darkAccent" } };
  (nodes["bodyMiddle"] ?? root).add(node_button2_17);
  nodes["button2"] = node_button2_17;
  const mesh_button2_17Geometry = endpoint_button2_17 ? new THREE.CylinderGeometry(endpoint_button2_17.endRadius, endpoint_button2_17.baseRadius, endpoint_button2_17.length, 32, 12) : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_button2_17) {
  ...
  if (endpoint_button3_18) {
    ...
    node_button3_18.rotation.set(0, 0, 0);
  } else {
    node_button3_18.position.set(0.0854, -0.2181, 0.3345);
    node_button3_18.rotation.set(0, 0, 0);
  }
  node_button3_18.userData.sculptComponent = { "id": "button3", "name": "Coal button (bottom)", "level": "micro", "role": "detail", "importance": 0.4, "confidence": 0.85, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "First of 3 small dark spheres in a vertical row on the middle sphere's front.", "geometryDescriptor": { "topologyIntent": "smooth continuous surface, standard tessellation", "edgeTreatment": { "type": "rounded", "bevelRadius": 0.01, "segments": 2 }, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry" }, "parent": "bodyMiddle", "attachment": { "parentSocket": "bodyMiddle.front", "contactType": "embedded-in", "localStart": [0, -1.2313, 0], "localEnd": [0, -1.2313, 0], "embedDepth": 0.0107, "gapTolerance": 0 }, "dimensions": { "radius": 0.0302, "units": "world", "confidence": 0.85, "height": 0.0604, "width": 0.0604, "depth": 0.0604 }, "transform": { "position": [0.0854, -0.2181, 0.3345], "rotation": [0, 0, 0] }, "actionProfile": { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "darkAccent" } }, "material": "darkAccent", "materialLayers": ["darkAccent"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": { "macroRoughness": 0.15, "microRoughness": 0.05, "bumpAmplitude": 0, "normalPattern": "none", "displacementPattern": "none", "occlusionPattern": "contact-seam-darkening", "edgeWearPattern": "none", "notes": "" }, "evidenceRefs": ["zone-r2c1"], "details": [], "fidelityTier": "micro", "colorMaterialRecipe": { "materialClass": "plastic", "materialClassConfidence": 0.8, "colorGradient": { "type": "linear", "stops": [{ "position": 0, "color": "rgba(26, 26, 26, 1.0)" }, { "position": 1, "color": "rgba(26, 26, 26, 1.0)" }] }, "dominantAlbedo": "rgba(26, 26, 26, 1.0)", "secondaryAlbedo": "rgba(26, 26, 26, 1.0)" } };
  node_button3_18.userData.actionProfile = { "animationRole": "static", "pivot": { "mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85 }, "transformChannels": { "translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true }, "sockets": [], "collider": { "type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "Decorative prop -- proxy collider only, no physics interaction required." }, "constraints": [], "destruction": { "breakable": false, "fractureGroup": "root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "darkAccent" } };
  (nodes["bodyMiddle"] ?? root).add(node_button3_18);
  nodes["button3"] = node_button3_18;
  const mesh_button3_18Geometry = endpoint_button3_18 ? new THREE.CylinderGeometry(endpoint_button3_18.endRadius, endpoint_button3_18.baseRadius, endpoint_button3_18.length, 32, 12) : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_button3_18) {
...
function createStylizedSnowmanFigureLookDevLights(mode = "neutral") {
...
function createStylizedSnowmanFigureEnvironment(renderer) {
  const pmrem = new THREE.PMREMGenerator(renderer);
  const texture = pmrem.fromScene(new RoomEnvironment(), 0.04).texture;
  pmrem.dispose();
  return texture;
}
function frameStylizedSnowmanFigureCamera(camera, object, options = {}) {
...
function createStylizedSnowmanFigurePresentationComposer(renderer, scene, camera, options = {}) {
...
function configureStylizedSnowmanFigureRenderer(renderer) {
  renderer.toneMapping = THREE.ACESFilmicToneMapping;
  renderer.outputColorSpace = THREE.SRGBColorSpace;
}
function createStylizedSnowmanFigureInspectControls(camera, domElement) {
...
export {
  configureStylizedSnowmanFigureRenderer,
  createStylizedSnowmanFigureEnvironment,
  createStylizedSnowmanFigureInspectControls,
  createStylizedSnowmanFigureLookDevLights,
  createStylizedSnowmanFigureModel,
  createStylizedSnowmanFigurePresentationComposer,
  frameStylizedSnowmanFigureCamera
};
